...
tab <- tabdata %>%
  ...
  tab_header(
    ...
    subtitle = "SALT-cap repeal compared to current 2021 law"
  ) %>%
  cols_label(
      stub = "",
...
# configure save settings for wide table
gtsave(tab, "USImpact_averages_xpinc_table.png", path = here::here("results"), zoom=1.5, vwidth=1500)  # zoom 2 default
write_csv(tabdata, here::here("results", "USImpact_averages_xpinc_table_data.csv"))
...
# configure save settings for wide table
gtsave(tab, "USImpact_averages_dispinc_table.png", path = here::here("results"), zoom=1.5, vwidth=1500)  # zoom 2 default
write_csv(tabdata, here::here("results", "USImpact_averages_dispinc_table_data.csv"))
...
# configure save settings for wide table
gtsave(tab, "states_detailed_table_xpinc.png", path = here::here("results"), zoom=2, vwidth=1500)  # zoom 2 default
write_csv(tabdata, here::here("results", "states_detailed_table_xpinc_data.csv"))
...
# configure save settings for wide table
gtsave(tab, "states_detailed_table_dispinc.png", path = here::here("results"), zoom=2, vwidth=1500)  # zoom 2 default
write_csv(tabdata, here::here("results", "states_detailed_table_dispinc_data.csv"))
...
write_csv(df, here::here("results", "iitax_change_hbars_data.csv"))
...
write_csv(df, here::here("results", "iitax_change_hbars_numbers_data.csv"))
