...
wsums <- wstack %>%
  ...
  select(-c(RECID, filer2017, numret, 
            c00100, e00200, c18300, c04470, standard, combined, iitax, agibase, xpinc)) %>%
...
data4 <- data3 %>%
  filter(measure %in% c("wtdsum", "avgval"), variable %in% c("iitax", "xpincxreform")) %>%
